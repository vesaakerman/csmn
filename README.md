...
Video documents intentionally use a small metadata set: English title, slug, YouTube/Vimeo URL, optional custom thumbnail, English description, collection, tags, extra search terms, published date, and submitted-by metadata.
